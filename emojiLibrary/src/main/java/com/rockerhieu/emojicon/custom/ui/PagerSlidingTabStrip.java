...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = com.rockerhieu.emojicon.R.drawable.background_tab;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		a = context.obtainStyledAttributes(attrs,
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip);

		indicatorColor = a.getColor(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsIndicatorColor,
				indicatorColor);
		underlineColor = a.getColor(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsUnderlineColor,
				underlineColor);
		dividerColor = a
				.getColor(com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsDividerColor,
						dividerColor);
		indicatorHeight = a.getDimensionPixelSize(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight,
				indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight,
				underlineHeight);
		dividerPadding = a.getDimensionPixelSize(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsDividerPadding,
				dividerPadding);
		tabPadding = a.getDimensionPixelSize(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight,
				tabPadding);
		tabBackgroundResId = a.getResourceId(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsTabBackground,
				tabBackgroundResId);
		shouldExpand = a
				.getBoolean(com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsShouldExpand,
						shouldExpand);
		scrollOffset = a
				.getDimensionPixelSize(
						com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsScrollOffset,
						scrollOffset);
		textAllCaps = a.getBoolean(
				com.rockerhieu.emojicon.R.styleable.PagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
